...
public class Stage implements MemoryObject {
    ...
    private static Marker[] randomMarkers = { Marker.Note, Marker.OctaveUp, Marker.OctaveDown, Marker.Longer, Marker.Repeat, Marker.Skip };
    ...
    public void putMarker(int index, Marker marker) {
        if (marker == Marker.Random && markers[index] != Marker.Random) {
            randomCount++;
        } else if (marker != Marker.Random && markers[index] == Marker.Random) {
            randomCount--;
        }
