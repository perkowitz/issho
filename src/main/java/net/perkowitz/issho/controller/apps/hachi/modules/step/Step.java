...
public class Step {
    ...
    public static MultiNoteMode multiNoteMode = MultiNoteMode.ORDER_LOW_TO_HIGH; // TODO: fully implement other modes, make them settable

    @Getter @Setter private static int[] scale = DEFAULT_SCALE;

    @Getter private Mode mode = Mode.Rest;
        ...
        if (mode == Mode.Rest) {
            for (int r = 0; r < repeats; r++) {
                ...
                for (int t = 0; t < longer; t++) {
                    steps.add(new Step(Mode.Tie, 0, velocity));
                }
            }
            ...
            for (int i = 0; i < baseNotes.size(); i++) {
                ...
                for (int r = 0; r < repeats; r++) {
                    ...
                    for (int t = 0; t < longer; t++) {
                        steps.add(new Step(Mode.Tie, note, velocity, highlight));
                    }
                }
            }
        }
