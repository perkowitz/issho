...
public class ColorModes {
    ...
    static {
        ...
        twoBitMap.put(Colors.BRIGHT_LIME, 0);
        twoBitMap.put(Colors.DIM_LIME, 0);
        twoBitMap.put(Colors.BRIGHT_GREEN, 107);
        twoBitMap.put(Colors.DIM_GREEN, 108);
        twoBitMap.put(Colors.BRIGHT_SAGE, 0);
        twoBitMap.put(Colors.DIM_SAGE, 0);
        twoBitMap.put(Colors.BRIGHT_CYAN, 109);
        twoBitMap.put(Colors.DIM_CYAN, 110);
        twoBitMap.put(Colors.BRIGHT_SKY, 0);
        twoBitMap.put(Colors.DIM_SKY, 0);
        ...
        twoBitMap.put(Colors.BRIGHT_CRIMSON, 0);
        twoBitMap.put(Colors.DIM_CRIMSON, 0);
