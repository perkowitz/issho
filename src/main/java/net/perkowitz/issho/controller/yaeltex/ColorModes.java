...
public class ColorModes {
    ...
    static {
        ...
        twoBitMap.put(Colors.BRIGHT_LIME, 88);
        twoBitMap.put(Colors.DIM_LIME, 89);
        twoBitMap.put(Colors.BRIGHT_GREEN, 107);
        twoBitMap.put(Colors.DIM_GREEN, 108);
        twoBitMap.put(Colors.BRIGHT_SAGE, 90);
        twoBitMap.put(Colors.DIM_SAGE, 91);
        twoBitMap.put(Colors.BRIGHT_CYAN, 109);
        twoBitMap.put(Colors.DIM_CYAN, 110);
        twoBitMap.put(Colors.BRIGHT_SKY, 92);
        twoBitMap.put(Colors.DIM_SKY, 93);
        ...
        twoBitMap.put(Colors.BRIGHT_CRIMSON, 94);
        twoBitMap.put(Colors.DIM_CRIMSON, 95);
