 ...
 */
public class Drawing2Module extends BasicModule implements Clockable {

    // memory sizes
    private static int FRAMES_PER_SESSION = 64;
...
//            System.out.println(json);
    ...
    private static class Frame {
        ...
        @JsonSerialize @JsonDeserialize private Color[][] pixels;
        @JsonSerialize @JsonDeserialize @Getter private boolean untouched;
    ...
    private static class Pattern {
        ...
        @Getter @Setter private int startFrame;
        @Getter @Setter private int endFrame;

        public Pattern() {
            startFrame = 0;
            endFrame = FRAMES_PER_SESSION - 1;
        }
    ...
    private static class Session {
        ...
        public Frame nextFrame() {
            currentFrameIndex = (currentFrameIndex + 1) % FRAMES_PER_SESSION;
    ...
    private static class Memory {
        ...
        @JsonIgnore
        public Pattern getCurrentPattern() {
            return getCurrentSession().getCurrentPattern();
        }
...
//            return getCurrentSession().getCurrentPatternIndex();
//        }
//
//        @JsonIgnore
