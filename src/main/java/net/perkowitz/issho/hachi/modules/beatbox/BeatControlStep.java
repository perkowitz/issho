...
import static net.perkowitz.issho.hachi.modules.beatbox.BeatStep.GateMode.*;

/**
 * Created by optic on 2/25/17.
 */
public class BeatControlStep {
    ...
    public BeatControlStep() {}

    public BeatControlStep(int index) {
        this.index = index;
    ...
    public static BeatControlStep copy(BeatControlStep step, int newIndex) {
        BeatControlStep newStep = new BeatControlStep(newIndex);
