...
public class MonoModule2 extends MidiModule implements Module, Clockable, GridListener, Sessionizeable, Chordable {
    ...
    private GridControlSet modeControls = GridControlSet.buttonSide(GridButton.Side.Bottom);
    private GridControlSet valueControls = GridControlSet.buttonSide(GridButton.Side.Right);
