...
public class StepUtil {
    ...
    static {
        markerPaletteMap.put(new GridControl(GridButton.at(GridButton.Side.Bottom, 0), 0), Stage.Marker.None);
        markerPaletteMap.put(new GridControl(GridButton.at(GridButton.Side.Bottom, 1), 1), Stage.Marker.Note);
